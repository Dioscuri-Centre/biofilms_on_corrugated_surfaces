...
#define MUTATION_MODE 4 // if defined, mutations occurs during growth. their fitness advantage is fit_adv. 
/*  modes:
...
double bottom_period=20, bottom_ampl=2 ;
#endif
...
int save_cells=1+2+16+32+64 ; // if non-zero, save all and save positions etc. of all cells. 
...
int width=100, height=110 ; //40 or 110 ; // size [um] of the simulation box, otherwise not used
double depth=3 ; // used only for 3d
